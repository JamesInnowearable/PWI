function SCENARIO1_FEAT(rootDir,foldername, scenario, activity, testperson)
plot_on = 1
...
%Calculation Change counts to percent of total time as a score bewtween 0-1 (eg 15% = 0,15)
Trunk_PWI = (T2_wt * detaTimeinPosition_Flexion20_45) + (T3_wt * detaTimeinPosition_Flexion45) + (T4_wt * detaTimeinPosition_TwistNeutral) + (T5_wt1 * detaTimeinPosition_TwistFlexion); 
Arm_PWI = (A2_wt * detaTimeinPositionSinlgeArm) + (A3_wt * detaTimeinPosition_InisializationArms); 
Leg_PWI = (L6_wt * detaTimeinPosition_SquatSupp80) + (L3_wt * detaTimeinPosition_ShallowSquat);
